...
public class DivrollUser extends DivrollBase {
  ...
  public void create(String username, String password) {
    try {
      ...
      if (response.getStatus() >= 500) {
        ...
        try {
          publicRead =
              responseUser.get("publicRead") != null ? responseUser.getBoolean("publicRead") : null;
        } catch (Exception e) {
        ...
        try {
          publicWrite =
              responseUser.get("publicWrite") != null
                  ? responseUser.getBoolean("publicWrite")
                  : null;
        } catch (Exception e) {
  ...
  public void retrieve() {
    try {
      GetRequest getRequest =
          (GetRequest) Unirest.get(Divroll.getServerUrl() + usersUrl + "/" + getEntityId());
      ...
      if (response.getStatus() >= 500) {
        ...
        try {
          publicRead =
              userJsonObj.get("publicRead") != null ? userJsonObj.getBoolean("publicRead") : null;
        } catch (Exception e) {
        ...
        try {
          publicWrite =
              userJsonObj.get("publicWrite") != null ? userJsonObj.getBoolean("publicWrite") : null;
        } catch (Exception e) {
  ...
  public boolean delete() {
    try {
      HttpRequestWithBody httpRequestWithBody =
          Unirest.delete(Divroll.getServerUrl() + usersUrl + "/" + getEntityId());
      if (Divroll.getMasterKey() != null) {
        httpRequestWithBody.header(HEADER_MASTER_KEY, Divroll.getMasterKey());
      }
      if (Divroll.getAppId() != null) {
  ...
  public void login(String username, String password) {
    ...
    try {
      GetRequest getRequest =
          (GetRequest)
              Unirest.get(Divroll.getServerUrl() + loginUrl)
